...
def redrawAll(canvas,data):
   ...
   #draw background
    ...
    #draw mini map
    (x0,y0)=(900,600)
    canvas.create_rectangle(x0,y0,x0+100,y0+100,fill="black",outline="white")
    (x1,y1,r1)=(data["snake"].bodypart[0].x/50,data["snake"].bodypart[0].y/50,data["snake"].r/5)
    canvas.create_oval(x0+x1-r1,y0+y1-r1,x0+x1+r1,y0+y1+r1,fill=data["snake"].color)
    for l in data["aisnake"]:
        (x1,y1,r1)=(l.bodypart[0].x/50,l.bodypart[0].y/50,l.r/10)
